                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-12">
                                                    <input required type="text" class="form-control form-control-sm"
                                                        name="booking_number" placeholder="Invoice Number/Booking Number" autocomplete="off">
                                                </div>
                                                <div class="col-md-12">
...
<div class="footer-logo-partner col-lg-10 offset-lg-1 text-center d-lg-flex mb-0 justify-content-center">
    ...
    <img src="{{ asset('assets/images/spd-logo.png') }}" class="px-2 transition-hover-zoom footer-logo-height" width="" height="" >
