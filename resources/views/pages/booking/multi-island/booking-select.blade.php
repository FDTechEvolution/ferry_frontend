                                ...
                                <div class="row py-3 pb-lg-3 pb-2">
                                    ...
                                    <div class="col-11 col-lg-7 d-flex align-items-center mb-2 pb-2 pb-lg-0 mb-lg-0 border-bottom-m fs--14-m">
                                        <p class="mb-0 me-2">
                                            ...
                                            <span class="small">{{ $route['station_from']['name'] }} @if($route['station_from']['piername'] != NULL) ({{$route['station_from']['piername']}}) @endif <x-booking-master-info :station_line="$route['station_lines']" :info="$route['master_from']" :station="$route['station_from']['name']"/></span>
                                        </p>
                                        <span class="mx-1">
                                        ...
                                        <p class="mb-0 ms-2">
                                            ...
                                            <span class="small">{{ $route['station_to']['name'] }} @if($route['station_to']['piername'] != NULL) ({{$route['station_to']['piername']}}) @endif <x-booking-master-info :station_line="$route['station_lines']" :info="$route['master_from']" :station="$route['station_to']['name']"/></span>
                                        </p>
                                    </div>
