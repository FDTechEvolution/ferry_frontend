    ...
    <div class="row mb-4">
        ...
        <div class="col-12 col-lg-11 ms-0 ms-lg-5 booking-route-select">
            @foreach($routes['data'] as $key => $route)
                <div class="row p-2 px-4 mb-4 border rounded booking-route-list list-index_{{ $index }} list-position_{{ $index }}_{{ $key }} @if(!$route['do_booking']) over-time bg-dark-light @endif" data-list="{{ $index }}" data-key="{{ $key }}">
                                ...
                                <div class="text-end">
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-lg-12 mt-2 mt-lg-0 mb-lg-2">
                                            <button type="button" class="btn btn-sm button-blue-bg btn-route-list_{{ $index }} btn-route-select-{{ $index }}_{{ $key }}">Select</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
