            ...
            <div class="col-12 mt-3" id="lead-passenger">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-5 form-floating mb-3">
                        ...
                        <label for="passenger-last-name" class="ms-2">Last name<span
                                class="text-danger">*</span></label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 col-lg-7 form-floating mb-3">
                        <input required type="text" name="birth_day[]"
                            ...
                            data-today-highlight="true" data-today-btn="false" data-clear-btn="false"
                            data-autoclose="true" data-format="DD/MM/YYYY" autocomplete="off"
                ...
                <div class="row mb-3 mb-lg-0">
                    <div class="col-12 col-lg-7">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-floating mb-3">
                                    <input required type="email" name="confirm_email"
                                        class="form-control form-control-sm" id="passenger-confirm-email"
                                        placeholder="Confirm E-mail" onselectstart="return false" onpaste="return false"
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="row">
                            ...
                            <div class="col-12 mt-4 pt-1">
                                <label class="form-label position-absolute mt-n4">Thai telephone number (if
                                    any)</label>
                                <div class="row">
                                    <div class="col-4">
