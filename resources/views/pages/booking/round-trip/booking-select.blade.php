                            ...
                            <div class="row py-3 pb-lg-3 pb-2">
                                ...
                                <div class="col-11 col-lg-7 d-flex align-items-center mb-2 pb-2 pb-lg-0 mb-lg-0 border-bottom-m fs--14-m">
                                    <p class="mb-0 me-2">
                                        ...
                                        <span class="small station-depart-from-text">{{ $route['station_from']['name'] }} @if($route['station_from']['piername'] != NULL) ({{$route['station_from']['piername']}}) @endif <x-booking-master-info :info="$route['master_from']" :station="$route['station_from']['name']"/></span>
                                    </p>
                                    ...
                                    <p class="mb-0 ms-2">
                                        ...
                                        <span class="small station-depart-to-text">{{ $route['station_to']['name'] }} @if($route['station_to']['piername'] != NULL) ({{$route['station_to']['piername']}}) @endif <x-booking-master-info :info="$route['master_to']" :station="$route['station_to']['name']"/></span>
                                    </p>
                                </div>
                        ...
                        <div class="col-12 col-lg-10">
                            <div class="row py-3 pb-lg-3 pb-2">
                                ...
                                <div class="col-11 col-lg-7 d-flex align-items-center mb-2 pb-2 pb-lg-0 mb-lg-0 border-bottom-m fs--14-m">
                                    <p class="mb-0 me-2">
                                        <span class="depart-time">{{ date("H:i", strtotime($route['depart_time'])) }}</span><br/>
                                        <span class="small station-return-from-text">{{ $route['station_from']['name'] }} @if($route['station_from']['piername'] != NULL) ({{$route['station_from']['piername']}}) @endif <x-booking-master-info :info="$route['master_from']" :station="$route['station_from']['name']"/></span>
                                    </p>
                                    <span class="mx-0 mx-md-3">
                                        <svg width="18px" height="18px" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-chevron-double-right" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M3.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L9.293 8 3.646 2.354a.5.5 0 0 1 0-.708z"></path>
                                    ...
                                    <p class="mb-0 ms-2">
                                        <span class="arrival-time">{{ date("H:i", strtotime($route['arrive_time'])) }}</span><br/>
                                        <span class="small station-return-to-text">{{ $route['station_to']['name'] }} @if($route['station_to']['piername'] != NULL) ({{$route['station_to']['piername']}}) @endif <x-booking-master-info :info="$route['master_to']" :station="$route['station_to']['name']"/></span>
                                    </p>
                                </div>
