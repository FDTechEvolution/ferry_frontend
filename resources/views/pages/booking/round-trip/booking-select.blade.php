<div id="booking-route-select">
    <div class="mb-5" id="booking-depart">
        ...
        <div class="col-12 col-lg-11 ms-0 ms-lg-5 ps-lg-3 pb-lg-4 border-start border-2 booking-route-select" style="border-color: #16aded !important;">
            @foreach ($depart_routes as $index => $route)
                <div
                    class="row p-2 px-4 mx-1 mb-2 border bg-white shadow rounded booking-depart-list @if (!$route['do_booking']) over-time bg-dark-light @endif">
                    <div class="col-12">
                        <div class="row">
                            <div class="col-12 col-lg-10">
                                <div class="row py-3 pb-lg-3 pb-2">
                                        ...
                                        <div class="partner-image me-3">
                                            @if ($route['partner'] != null)
                                                <div class="avatar avatar-md"
                                                    style="background-image:url({{ $icon_url . '/' . $route['partner']['image']['path'] }})">
                                                </div>
                                            @else
                                                <div class="avatar avatar-md"
                                                    style="background-image:url({{ asset('tiger-line-partner.jpg') }})">
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <p class="mb-0 me-2">
                                            ...
                                            <span
                                                class="small station-depart-from-text">{{ $route['station_from']['name'] }}
                                        ...
                                        <p class="mb-0 ms-2">
                                            ...
                                            <span class="small station-depart-to-text">{{ $route['station_to']['name'] }}
                                    ...
                                    @if ($route['text_1'] != '')
                                        <div
                                            class="col-9 col-lg-3 route-text d-flex justify-content-start align-items-center">
                                ...
                                <div class="row pt-2 border-top">
                                    <div
                                        class="col-12 col-lg-4 route-icon d-flex align-items-center justify-content-lg-start justify-content-center">
                                        <x-booking-select-icon :icons="$route['icons']" :icon_url="$icon_url" />
                                    </div>

                                    @if ($route['text_2'] != '')
                                        <div
                                            class="col-12 col-lg-8 d-flex align-items-center justify-content-center justify-content-lg-start">
                            ...
                            <div
                                class="col-12 col-lg-2 mt-lg-0 mt-3 d-lg-flex justify-content-lg-center align-items-lg-center booking-selected-zone">
                                <div class="text-end">
                                    <div class="row">
                                        <div class="col-6 col-lg-12 mb-0 text-center-m" style="line-height: 18px;">
                                            <p class="mb-0 position-relative">
                                                ...
                                                @if (isset($route['promo_price']) && $route['promo_price'] != 0)
                                                    <span
                                                        class="smaller text-danger current-price"><s>{{ number_format($route['amount']) }}</s></span>
                                                    <span
                                                        class="route-price promo-price fs-4">{{ number_format($route['promo_price']) }}</span>
                                                @else
                                                    <span
                                                        class="route-price fs-4">{{ number_format($route['amount']) }}</span>
                                                @endif
                                            </p>
                                            <p class="mb-1 smaller">For {{ $passenger[0] + $passenger[1] + $passenger[2] }}
                                                passenger(s)</p>
                                        </div>
    ...
    <div class="mt-4" id="booking-return">
        ...
        <div class="col-12 col-lg-11 ms-0 ms-lg-5 ps-lg-3 pb-lg-4 border-start border-2 booking-route-select" style="border-color: #ff6100 !important;">
            @foreach ($return_routes as $index => $route)
                <div
                    class="row p-2 px-4 mx-1 mb-2 bg-white shadow border rounded booking-return-list @if (!$route['do_booking']) over-time bg-dark-light @endif">
                    <div class="col-12">
                        <div class="row">
                            <div class="col-12 col-lg-10">
                                <div class="row py-3 pb-lg-3 pb-2">
                                    ...
                                    <div
                                        ...
                                        <p class="mb-0 me-2">
                                            <span
                                                class="depart-time">{{ date('H:i', strtotime($route['depart_time'])) }}</span><br />
                                            <span
                                                class="small station-return-from-text">{{ $route['station_from']['name'] }}
                                                @if ($route['station_from']['piername'] != null)
                                                    ({{ $route['station_from']['piername'] }})
                                                @endif
                                                <x-booking-master-info
                                        ...
                                        <p class="mb-0 ms-2">
                                            <span
                                                class="arrival-time">{{ date('H:i', strtotime($route['arrive_time'])) }}</span><br />
                                            <span class="small station-return-to-text">{{ $route['station_to']['name'] }}
                                                @if ($route['station_to']['piername'] != null)
                                                    ({{ $route['station_to']['piername'] }})
                                                @endif
                                                <x-booking-master-info
                                ...
                                <div class="text-end">
                                    <div class="row">
                                        <div class="col-6 col-lg-12 mb-0 text-center-m" style="line-height: 18px;">
                                            ...
                                            <p class="mb-1 smaller">For
                                                {{ $passenger[0] + $passenger[1] + $passenger[2] }} passenger(s)</p>
                                        </div>
                                        <div class="col-6 col-lg-12 mt-2 mt-lg-0 mb-lg-2 text-center-m">
                                            <button type="button"
