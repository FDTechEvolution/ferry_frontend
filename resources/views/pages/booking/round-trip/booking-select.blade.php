    ...
    <div class="mb-5" id="booking-depart">
        ...
        <div class="col-12 col-lg-11 ms-0 ms-lg-5 ps-lg-3 pb-lg-4 border-start border-2 booking-route-select" style="border-color: #16aded !important;">
            @foreach ($depart_routes as $index => $route)
                <div
                    class="row p-2 px-4 mx-1 mb-2 border bg-white shadow rounded booking-depart-list @if (!$route['do_booking']) over-time bg-dark-light @endif" data-id="{{ $route['id'] }}">
                    <div class="col-12">
                        <div class="row">
                    ...
                    <input type="hidden" class="route-status-depart" value="{{ $route['ispromocode'] }}">
                </div>
            @endforeach
        </div>
