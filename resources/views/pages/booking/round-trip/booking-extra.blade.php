                ...
                <div class="col-12 mb-3 pb-2 border-bottom">
                    <div class="row">
                        ...
                        <div class="col-2 d-flex justify-content-center align-items-center">
                            ...
                            <input type="number" name="meal_qty[]" id="depart-meal-index-{{ $key }}" class="form-control form-control-xs text-center mx-2 border-0" value="0" readonly>
                ...
                <div class="col-12 mb-3 pb-2 border-bottom">
                    <div class="row">
                        ...
                        <div class="col-2 d-flex justify-content-center align-items-center">
                            ...
                            <input type="number" name="activity_qty[]" id="depart-activity-index-{{ $key }}" class="form-control form-control-xs text-center mx-2 border-0" value="0" readonly>
                ...
                <div class="col-12 mb-3 pb-2 border-bottom">
                    <div class="row">
                        ...
                        <div class="col-2 d-flex justify-content-center align-items-center">
                            ...
                            <input type="number" name="meal_qty[]" id="return-meal-index-{{ $key }}" class="form-control form-control-xs text-center mx-2 border-0" value="0" readonly>
                            <input type="hidden" name="meal_id[]" value="{{ $meal['id'] }}">
                ...
                <div class="col-12 mb-3 pb-2 border-bottom">
                    <div class="row">
                        ...
                        <div class="col-2 d-flex justify-content-center align-items-center">
                            ...
                            <input type="number" name="activity_qty[]" id="return-activity-index-{{ $key }}" class="form-control form-control-xs text-center mx-2 border-0" value="0" readonly>
                            <input type="hidden" name="activity_id[]" value="{{ $activity['id'] }}">
