        ...
        <div class="row min-h-50vh">
            <div class="col-12">
                ...
                <form novalidate class="bs-validate" id="booking-form" method="POST" action="{{ route('booking-confirm') }}">
                    ...
                    <div class="row mt-3">
                        <div class="col-6">
                            <a href="{{ route('home') }}" class="btn btn-sm btn-secondary border-radius-10 d-none" id="btn-back-to-home" style="margin-left: 0.5rem;">
                                << Back</a>
                                    <button type="button" class="btn btn-sm btn-secondary border-radius-10" id="progress-prev" disabled>
                                        << Back</button>
                        </div>
                        <div class="col-6 text-end">
                            <x-button-green id="progress-next" class="btn-sm" :type="_('button')" :text="_('Continue >>')" disabled />
                            <x-button-green id="progress-next-passenger" class="btn-sm d-none" :type="_('button')" :text="_('Book / Payment')" onClick="progressPassenger()" disabled />
                            <x-button-green id="progress-payment" class="btn-sm d-none" :type="_('button')" :text="_('Book / Payment')" disabled />
                        </div>
                    </div>
                </form>
                @endif
...
<style>
    ...
    .summary-dropdown.show {
        width: 360px;
    }

</style>
<script>
    let isStep = @json($isType == '' ? 0 : 1)
