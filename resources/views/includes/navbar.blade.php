    ...
    <nav class="navbar navbar-expand-lg navbar-light justify-content-lg-between justify-content-md-inherit">
        ...
        <ul class="list-inline list-unstyled mb-0 d-flex align-items-end">
            <li class="list-inline-item mx-1 dropdown text-center">
                ...
                <!-- ALREADY SIGNED IN -->
                <!--
                <a href="#" aria-label="Account Options" id="dropdownAccountOptions" class="btn btn-sm btn-light btn-pill" data-bs-toggle="dropdown" aria-expanded="false" aria-haspopup="true">
                    <span>Account</span>
                    <span class="group-icon">
                        <i class="fi fi-user-male"></i>
                        <i class="fi fi-close"></i>
