    ...
    <div class="col-12 mt-3">
        <div class="row">
            ...
            <div class="col-5 form-floating mb-3">
                <input required type="text" class="form-control form-control-sm" id="passenger-first-name-{{ $first_name }}" placeholder="First name & Middle name">
                <label for="passenger-first-name-{{ $first_name }}" class="ms-2">First name & Middle name<span class="text-danger">*</span></label>
            </div>
            <div class="col-5 form-floating mb-3">
                <input required type="text" class="form-control form-control-sm" id="passenger-last-name-{{ $last_name }}" placeholder="Last name">
